...
$.ajax({
  ...
  data: {
    key: 'CTJBZ-MENWI-3W2GQ-UPB4W-JX4HT-MPBWI',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(104.15140183708081, 35.940243449173146, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
<a class="swf" id="swf_SourceCodePro" href="javascript:;" rel="noopener external nofollow" style="font-family:'SourceCodePro'!important;color:black" onclick="setFont('SourceCodePro')">SourceCodePro</a>
